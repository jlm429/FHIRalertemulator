...
function statusFormatter(value, row) {
	...
	if (value == "CDC") {
		labelColor = "cdc";
	}else if(value == "FDA Drug Recall"){
    labelColor = "fdadrugrecall";
  }else if(value == "New Vaccine"){
    labelColor = "newvaccine";
  }else if(value == "New Generic Drug"){
    labelColor = "newgenericdrug";
	}
	var icon = row.id % 2 === 0 ? 'fa-star' : 'fa-user';
